        ...
        <View style={styles.container}>
            <ImageBackground 
                ...
                <View style={styles.center}>
                    ...
                    <TextInput placeholder="Name" style={styles.sameInput}>
                        
                    </TextInput>
                    <FontAwesome name="lock" size={30} color="black" style={{position: 'absolute', left: '20px', top: '80px'}} />
                    <TextInput placeholder="Password" secureTextEntry={true} style={styles.sameInput}>
                            
                    </TextInput>
                    <AntDesign name="eye" size={28} color="black" style={{position: 'absolute', right: '20px', top: '80px'}} />
                </View>
